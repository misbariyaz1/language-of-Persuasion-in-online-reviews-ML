...
Merge the 15 review data into once before using, this is because we cant able to upload file more than 25 mb in github,dataset file was more that so we splited or else you can downlaod from kaggle link is proivded below 
https://www.kaggle.com/datasets/snap/amazon-fine-food-reviews